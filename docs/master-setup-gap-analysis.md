...
| Metric | Initial (2026-05-20) | After Phase A.1 (2026-05-21) |
|---|---|---|
| Overall PDF coverage (weighted) | ~74% | **~75%** |
| PDF surfaces fully shipped (✅) | 24 / 49 | **25 / 49** |
| PDF surfaces partially shipped (⚠️) | 19 / 49 | 18 / 49 |
| PDF surfaces not shipped (❌) | 6 / 49 | **5 / 49** |
| Net-new screens needed to close | ~22 SPA pages | ~21 SPA pages (Sector master SPA page still pending — only BFF surface shipped) |
| Net-new backend modules needed | 2 modules (DQ Engine, Reconciliation) | unchanged |
| New tables required | 5 master-data tables | **4** (Sectors landed via 024_master_sectors.sql) |
