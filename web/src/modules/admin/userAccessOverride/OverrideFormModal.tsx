...
export function OverrideFormModal({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label={mode === 'create' ? 'Add access override' : 'Edit access override'}
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-6"
    >
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold">
            {mode === 'create' ? 'Add access override' : 'Edit access override'}
          </h2>
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t bg-slate-50 rounded-b-lg">
