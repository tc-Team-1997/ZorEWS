...
import { Badge, Button, DialogFooter, EnterpriseDialog, type BadgeTone } from '@/components/ui';
import {
  api,
...
export function NotificationTemplateTestFireModal({ template, onClose, onSent }: Props) {
  ...
  return (
    <EnterpriseDialog
      open
      onClose={onClose}
      title={`Test fire — ${template.name}`}
      size="md"
      testId="notification-template-test-fire-modal"
      footer={
        <DialogFooter
          onCancel={onClose}
          cancelLabel="Close"
