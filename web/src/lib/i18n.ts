...
const en = {
  ...
  nav: {
    ...
    regulatory_compliance_center: 'Regulatory Compliance Center',
    data_fabric_center: 'Data Fabric Center',
    enterprise_demo_center: 'Enterprise Demo Foundation',
    demo_readiness_center: 'Demo Readiness & UAT',
    digital_twin_center: 'Digital Twin Simulation',
    autonomous_risk_center: 'Autonomous Risk Center',
    ai_decisioning_center: 'AI Decisioning Center',
    integration_marketplace: 'Integration Marketplace',
    board_reporting_center: 'Board Reporting Center',
    event_streaming_center: 'Event Streaming Center',
    operations_center: 'Operations Center',
    risk_intelligence: 'Risk Intelligence Hub',
    alerts: 'Alerts',
    customers: 'Customers',
    ...
    rule_reports: 'Rule Engine Reports',
    ...
    ai_governance: 'AI Governance Center',
    ai_governance_monitoring: 'Model Monitoring',
    ai_governance_prediction_audit: 'Prediction Audit Logs',
    ai_governance_performance: 'Performance Tracking',
    ai_governance_drift: 'Drift Dashboard',
    ai_governance_reports: 'AI Governance Reports',
    iam_center: 'IAM Center',
    iam_center_lifecycle: 'User Lifecycle',
    iam_center_access_review: 'Access Review',
    iam_center_approvals: 'Approvals Inbox',
    iam_center_audit: 'User Audit History',
    iam_center_password_policy: 'Password Policy',
    iam_center_sessions: 'Session Governance',
    security_center: 'Security Activity Center',
    governance_center: 'Governance Center',
    governance_center_organization: 'Organization',
    governance_center_domains: 'Domains',
    governance_center_roles: 'Roles',
    governance_center_risk: 'Risk & Alerts',
    governance_center_calendar: 'Business Calendar',
    master_setup: 'Master Setup',
    master_data: 'Master Data',
    permission_matrix: 'Permission Matrix',
    branches: 'Branches',
    compliance_rules: 'Compliance Rules',
    risk_score_config: 'Risk Score Config',
    alert_classification: 'Alert Classification',
    case_type_setup: 'Case Management Setup',
    job_scheduler: 'Job & Scheduler',
    access_control: 'Access Control',
    rules_engine: 'Rules Engine',
    rule_center: 'Rule Center',
    rule_center_builder: 'Rule Builder',
    rule_center_library: 'Rule Library',
    rule_center_testing: 'Rule Testing',
    rule_center_reports: 'Rule Reports',
    rule_center_history: 'Version History',
    rule_center_comparison: 'Rule Comparison',
    ...
    analytics: 'Analytics',
    risk_trend_config: 'Risk Trend Intelligence',
    ...
    recycle_bin: 'Recycle bin (legacy)',
    recovery_analytics: 'Recovery analytics (legacy)',
    audit_center: 'Audit Center',
    audit_center_trail: 'Audit Trail',
    audit_center_login_audit: 'Login Audit',
    audit_center_activity: 'Activity Logs',
    audit_center_export: 'Export Reports',
    audit_center_compliance: 'Compliance Reports',
    recovery_center: 'Recovery Center',
    recovery_center_deleted: 'Deleted Records',
    recovery_center_restore: 'Restore',
    recovery_center_permanent_delete: 'Permanent Delete',
    recovery_center_analytics: 'Recovery Analytics',
    recovery_center_workflow: 'Recovery Workflow',
    recovery_center_history: 'Recovery History',
    recovery_center_search: 'Recovery Search',
    recovery_center_policies: 'Recovery Policies',
...
const hi: typeof en = {
  ...
  nav: {
    ...
    regulatory_compliance_center: 'नियामक अनुपालन केंद्र',
    data_fabric_center: 'डेटा फ़ैब्रिक केंद्र',
    enterprise_demo_center: 'एंटरप्राइज़ डेमो फ़ाउंडेशन',
    demo_readiness_center: 'डेमो रेडीनेस और UAT',
    digital_twin_center: 'डिजिटल ट्विन सिमुलेशन',
    autonomous_risk_center: 'स्वायत्त जोखिम केंद्र',
    ai_decisioning_center: 'AI निर्णय केंद्र',
    integration_marketplace: 'एकीकरण मार्केटप्लेस',
    board_reporting_center: 'बोर्ड रिपोर्टिंग केंद्र',
    event_streaming_center: 'इवेंट स्ट्रीमिंग केंद्र',
    operations_center: 'ऑपरेशन केंद्र',
    risk_intelligence: 'जोखिम इंटेलिजेंस हब',
    alerts: 'अलर्ट',
    customers: 'ग्राहक',
    ...
    rule_reports: 'नियम इंजन रिपोर्ट',
    ...
    ai_governance: 'AI गवर्नेंस केंद्र',
    ai_governance_monitoring: 'मॉडल निगरानी',
    ai_governance_prediction_audit: 'भविष्यवाणी ऑडिट लॉग',
    ai_governance_performance: 'प्रदर्शन ट्रैकिंग',
    ai_governance_drift: 'ड्रिफ्ट डैशबोर्ड',
    ai_governance_reports: 'AI गवर्नेंस रिपोर्ट',
    iam_center: 'IAM केंद्र',
    iam_center_lifecycle: 'उपयोगकर्ता लाइफसाइकल',
    iam_center_access_review: 'एक्सेस समीक्षा',
    iam_center_approvals: 'अनुमोदन इनबॉक्स',
    iam_center_audit: 'उपयोगकर्ता ऑडिट इतिहास',
    iam_center_password_policy: 'पासवर्ड नीति',
    iam_center_sessions: 'सत्र शासन',
    security_center: 'सुरक्षा गतिविधि केंद्र',
    governance_center: 'गवर्नेंस केंद्र',
    governance_center_organization: 'संगठन',
    governance_center_domains: 'डोमेन',
    governance_center_roles: 'भूमिकाएँ',
    governance_center_risk: 'जोखिम और अलर्ट',
    governance_center_calendar: 'व्यावसायिक कैलेंडर',
    master_setup: 'मास्टर सेटअप',
    master_data: 'मास्टर डेटा',
    permission_matrix: 'अनुमति मैट्रिक्स',
    branches: 'शाखाएँ',
    compliance_rules: 'अनुपालन नियम',
    risk_score_config: 'रिस्क स्कोर कॉन्फ़िग',
    alert_classification: 'अलर्ट वर्गीकरण',
    case_type_setup: 'केस प्रबंधन सेटअप',
    job_scheduler: 'जॉब और शेड्यूलर',
    access_control: 'एक्सेस नियंत्रण',
    rules_engine: 'नियम इंजन',
    rule_center: 'नियम केंद्र',
    rule_center_builder: 'नियम निर्माता',
    rule_center_library: 'नियम पुस्तकालय',
    rule_center_testing: 'नियम परीक्षण',
    rule_center_reports: 'नियम रिपोर्ट',
    rule_center_history: 'संस्करण इतिहास',
    rule_center_comparison: 'नियम तुलना',
    ...
    integration_readiness: 'एकीकरण तत्परता',
    analytics: 'विश्लेषण',
    risk_trend_config: 'जोखिम प्रवृत्ति इंटेलिजेंस',
    ...
    recycle_bin: 'रिसायकल बिन (पुराना)',
    recovery_analytics: 'पुनर्प्राप्ति विश्लेषण (पुराना)',
    audit_center: 'ऑडिट केंद्र',
    audit_center_trail: 'ऑडिट ट्रेल',
    audit_center_login_audit: 'लॉगिन ऑडिट',
    audit_center_activity: 'गतिविधि लॉग',
    audit_center_export: 'निर्यात रिपोर्ट',
    audit_center_compliance: 'अनुपालन रिपोर्ट',
    recovery_center: 'पुनर्प्राप्ति केंद्र',
    recovery_center_deleted: 'हटाए गए रिकॉर्ड',
    recovery_center_restore: 'पुनर्स्थापित',
    recovery_center_permanent_delete: 'स्थायी रूप से हटाएँ',
    recovery_center_analytics: 'पुनर्प्राप्ति विश्लेषण',
    recovery_center_workflow: 'पुनर्प्राप्ति कार्यप्रवाह',
    recovery_center_history: 'पुनर्प्राप्ति इतिहास',
    recovery_center_search: 'पुनर्प्राप्ति खोज',
    recovery_center_policies: 'पुनर्प्राप्ति नीतियाँ',
...
const dz: typeof en = {
  ...
  nav: {
    ...
    regulatory_compliance_center: 'སྒྲིག་སྲོལ་མཐུན་འགྱུར་ལྟེ་གནས་',
    data_fabric_center: 'གཞི་གྲངས་སྦྲེལ་མཐུད་ལྟེ་གནས་',
    enterprise_demo_center: 'ཁྲོམ་ལས་གཞི་གྲངས་མཛོད་',
    demo_readiness_center: 'གྲ་སྒྲིག་དང་UAT་ལྟེ་གནས་',
    digital_twin_center: 'ཌི་ཇི་ཀིལ་ཚད་ལྡན་ལྟེ་གནས་',
    autonomous_risk_center: 'རང་འགུལ་ཉེན་ཁའི་ལྟེ་གནས་',
    ai_decisioning_center: 'AI ངེས་འབབ་ལྟེ་གནས་',
    integration_marketplace: 'སྙན་ཐོ་ཟམ་ར་',
    board_reporting_center: 'སྐྱིད་ཚོགས་སྙན་ཐོ་ལྟེ་གནས་',
    event_streaming_center: 'གཏོང་བཤེར་ལྟེ་གནས་',
    operations_center: 'བཀོལ་སྤྱོད་ལྟེ་གནས་',
    risk_intelligence: 'ཉེན་ཁའི་གཞི་རིག་ལྟེ་གནས་',
    alerts: 'དྲན་སྐུལ་',
    ...
    rule_reports: 'ཁྲིམས་ལུགས་ཀྱི་སྙན་ཞུ་',
    ...
    drift_detection: 'Drift Detection',
    ai_insights: 'AI Insights',
    ai_governance: 'AI འཛིན་སྐྱོང་ལྟེ་གནས་',
    ai_governance_monitoring: 'མ་དལ་ལྟ་རྟོག་',
    ai_governance_prediction_audit: 'སྔོན་དཔག་ཞིབ་དཔྱད་ཐོ་',
    ai_governance_performance: 'བྱེད་ནུས་སྔོན་བརྡ་',
    ai_governance_drift: 'འགུལ་ལས་ཀྱི་གཞི་སྡེ་',
    ai_governance_reports: 'AI འཛིན་སྐྱོང་སྙན་ཞུ་',
    iam_center: 'ཕ་ཡུལ་འཛིན་སྐྱོང་ལྟེ་གནས་',
    iam_center_lifecycle: 'སྤྱོད་མིའི་འཚོ་བའི་འཁོར་ལོ་',
    iam_center_access_review: 'འཛུལ་སྤྱོད་ཞིབ་བཤེར་',
    iam_center_approvals: 'མོས་མཐུན་ཡིག་ཁུག་',
    iam_center_audit: 'སྤྱོད་མིའི་ཞིབ་དཔྱད་ལོ་རྒྱུས་',
    iam_center_password_policy: 'ཕབ་ཚིག་སྲིད་བྱུས་',
    iam_center_sessions: 'འབྲེལ་བའི་འཛིན་སྐྱོང་',
    security_center: 'བདེ་འཇགས་ལས་སྤྱོད་ལྟེ་གནས་',
    governance_center: 'འཛིན་སྐྱོང་ལྟེ་གནས་',
    governance_center_organization: 'ཚོགས་སྡེ་',
    governance_center_domains: 'ཁྱབ་ཁོངས་',
    governance_center_roles: 'ལས་འགན་',
    governance_center_risk: 'ཉེན་ཁ་དང་གསལ་བསྒྲགས་',
    governance_center_calendar: 'ལས་ཀའི་ལོ་ཐོ་',
    master_setup: 'མ་གཞིའི་སྒྲིག་འགོད་',
    master_data: 'མ་གཞིའི་གནས་ཚུལ་',
    permission_matrix: 'དབང་ཚད་ཀྱི་མ་ལག་',
    branches: 'ཡན་ལག་',
    compliance_rules: 'ལུགས་མཐུན་སྒྲིག་གཞི་',
    risk_score_config: 'ཉེན་ཁ་སྐར་གྲངས་སྒྲིག་འགོད་',
    alert_classification: 'བརྡ་སྐུལ་དབྱེ་བ་',
    case_type_setup: 'གནད་དོན་དོ་དམ་སྒྲིག་འགོད་',
    job_scheduler: 'ལས་ཀ་དང་དུས་འགོད་',
    access_control: 'འཛུལ་སྤྱོད་ཚོད་འཛིན་',
    rules_engine: 'ནིའུ་མི་འཁོར་',
    rule_center: 'ཁྲིམས་ལུགས་ལྟེ་བ་',
    rule_center_builder: 'ཁྲིམས་ལུགས་བཟོ་མཁན་',
    rule_center_library: 'ཁྲིམས་ལུགས་ཁ་ཟས་',
    rule_center_testing: 'ཁྲིམས་ལུགས་བརྟག་དཔྱད་',
    rule_center_reports: 'ཁྲིམས་ལུགས་སྙན་ཞུ་',
    rule_center_history: 'ལོ་རྒྱུས་',
    rule_center_comparison: 'ཁྲིམས་ལུགས་སྡུར་',
    ...
    recycle_bin: 'སྤེལ་སྣོད་ (རྙིང་པ་)',
    recovery_analytics: 'སླར་གསོའི་དཔྱད་ཞིབ་ (རྙིང་པ་)',
    audit_center: 'ཞིབ་དཔྱད་ལྟེ་གནས་',
    audit_center_trail: 'ཞིབ་དཔྱད་འགོ་ལམ་',
    audit_center_login_audit: 'ནང་འཛུལ་ཞིབ་དཔྱད་',
    audit_center_activity: 'བྱ་སྤྱོད་ཐོ་',
    audit_center_export: 'ཕྱིར་ཕྱུང་སྙན་ཞུ་',
    audit_center_compliance: 'མཐུན་འགྲིག་སྙན་ཞུ་',
    recovery_center: 'སླར་གསོ་ལྟེ་གནས་',
    recovery_center_deleted: 'སུབ་ཟིན་པའི་ཐོ་',
    recovery_center_restore: 'སླར་གསོ་',
    recovery_center_permanent_delete: 'རྟག་པར་སུབ་',
    recovery_center_analytics: 'སླར་གསོའི་དཔྱད་ཞིབ་',
    recovery_center_workflow: 'སླར་གསོའི་ལས་རིམ་',
    recovery_center_history: 'སླར་གསོའི་ལོ་རྒྱུས་',
    recovery_center_search: 'སླར་གསོའི་འཚོལ་ཞིབ་',
    recovery_center_policies: 'སླར་གསོའི་སྲིད་བྱུས་',
...
const ne: typeof en = {
  ...
  nav: {
    ...
    regulatory_compliance_center: 'नियामक अनुपालन केन्द्र',
    data_fabric_center: 'डेटा फ़ैब्रिक केन्द्र',
    enterprise_demo_center: 'इन्टरप्राइज डेमो फाउन्डेशन',
    demo_readiness_center: 'डेमो तयारी र UAT',
    digital_twin_center: 'डिजिटल ट्विन सिमुलेशन',
    autonomous_risk_center: 'स्वायत्त जोखिम केन्द्र',
    ai_decisioning_center: 'AI निर्णय केन्द्र',
    integration_marketplace: 'एकीकरण मार्केटप्लेस',
    board_reporting_center: 'बोर्ड रिपोर्टिंग केन्द्र',
    event_streaming_center: 'इभेन्ट स्ट्रिमिङ केन्द्र',
    operations_center: 'अपरेशन केन्द्र',
    risk_intelligence: 'जोखिम इन्टेलिजेन्स हब',
    alerts: 'अलर्ट',
    customers: 'ग्राहक',
    ...
    rules: 'नियम',
    ews_rules: 'EWS नियम निर्माता',
    rule_reports: 'नियम इन्जिन रिपोर्ट',
    ...
    integration_readiness: 'एकीकरण तत्परता',
    analytics: 'विश्लेषण',
    risk_trend_config: 'जोखिम प्रवृत्ति बुद्धिमत्ता',
    ...
    case_scenarios: 'केस परिदृश्य',
    recycle_bin: 'रिसायकल बिन (पुरानो)',
    recovery_analytics: 'पुनःप्राप्ति विश्लेषण (पुरानो)',
    audit_center: 'अडिट केन्द्र',
    audit_center_trail: 'अडिट ट्रेल',
    audit_center_login_audit: 'लगइन अडिट',
    audit_center_activity: 'गतिविधि लग',
    audit_center_export: 'निर्यात रिपोर्ट',
    audit_center_compliance: 'अनुपालन रिपोर्ट',
    recovery_center: 'पुनःप्राप्ति केन्द्र',
    recovery_center_deleted: 'हटाइएका रेकर्ड',
    recovery_center_restore: 'पुनःस्थापित',
    recovery_center_permanent_delete: 'स्थायी रूपमा हटाउनुहोस्',
    recovery_center_analytics: 'पुनःप्राप्ति विश्लेषण',
    recovery_center_workflow: 'पुनःप्राप्ति कार्यप्रवाह',
    recovery_center_history: 'पुनःप्राप्ति इतिहास',
    recovery_center_search: 'पुनःप्राप्ति खोज',
    recovery_center_policies: 'पुनःप्राप्ति नीति',
