...
**Last updated:** 2026-05-04 (T4.24 Phase 9 — multi-tenant introspection: GET /v1/tenants/me + admin GET /v1/tenants; reports JSON variant enveloped)
