...
**Last updated:** 2026-05-04 (T6 M3.2 — Connector schema metadata shipped — per-connector field-level schemas (name, type, required, sample, enum, bounds) for all 8 M3.1 seed connectors + pure-function validator at `POST /v1/ingestion/connectors/:id/schema/validate`)
