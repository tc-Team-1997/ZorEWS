...
**Last updated:** 2026-05-05 (T6 M8.3 — Alert acknowledgment workflow shipped — per-alert ack/unack lifecycle with notes + history at `/v1/alerts/:id/{ack,unack,ack,ack/history}`; reason required on unack per RBI; 409 on conflict states)
