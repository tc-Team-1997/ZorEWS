...
**Last updated:** 2026-05-05 (T6 M15.3 — Audit evidence packaging shipped — `POST /v1/audit/evidence` builds frozen filtered snapshot + chain-integrity attestation; per-tenant capped retention at 100 packages; closes RBI/IRDAI evidence-request flow end-to-end)
