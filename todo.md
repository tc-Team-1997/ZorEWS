...
**Last updated:** 2026-05-04 (T4.24 Phase 8 — every public `/v1/*` JSON route now emits the bank-grade envelope; webhooks + rules + notifications + sla + integrations migrated)
