...
**Last updated:** 2026-05-04 (T4.24 Phase 5 — regulatory-svc/cases tenant-scoped: store, service, server, and BFF→cases proxy all thread tenant through)
