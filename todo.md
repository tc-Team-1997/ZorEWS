...
**Last updated:** 2026-05-05 (T6 M12.2 — Recurring report schedules shipped — daily/weekly/monthly cadences with pure-function `computeNextRun`; CRUD + `/due` polling endpoint + `/mark-run` advance; report_id + format cross-checked against M12.1 catalog; capped at 50/tenant)
