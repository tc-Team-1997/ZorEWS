...
| M16 | Scenarios                    | M16.1–M16.10                                | 10-preset library · bulk-run · diff · per-tenant CUSTOM presets CRUD · M16.5 wires custom through bulk-run + diff · M16.6 audit-history · M16.7 PUT with full re-validation + scenario.update audit · M16.8 single clone-from-library · M16.9 bulk-clone (cap 10; per-row created[]/skipped[]; name_prefix override; scenario.create audit per success with bulk=true marker) · M16.10 version snapshots on every create/update/restore (cap 20; monotonic numbering; restore audit carries `restored_from_version`; cross-tenant 404) |

**Totals:** **16/16 modules live · 107 T6 sub-phases shipped + parallel EWS rules engine (5 commits) · ~259 routes wired · BFF tests 4183 pass / 58 skipped / 4241 total.**
