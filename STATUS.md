...
| M4  | Indicators                   | M4.1–M4.6                                   | 25-indicator BIL insurance KRI catalog · indicator backtest · M4.3 threshold breach detection · M4.4 per-tenant overrides · M4.5 customer breach scan (deterministic, ranked red→green) · M4.6 bulk scan (cap 50; sorted by worst_class red-first; portfolio aggregate counts + customers_with_red + customers_attention_required) |
...
**Totals:** **16/16 modules live · 90 sub-phases shipped · ~212 routes wired · BFF tests 2692 pass / 9 skipped / 2701 total.**
