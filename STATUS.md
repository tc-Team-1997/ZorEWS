...
| M5  | Rule Engine                  | M5.1–M5.8                                   | 12-template library · bulk-clone preview · rule simulation · simulation BUNDLE · template diff · per-tenant CUSTOM templates CRUD · custom→simulation/diff merge · M5.8 PUT (edit) with re-validation + rule.create/update/delete audit events on every mutation + slim `/history` endpoint |
...
**Totals:** **16/16 modules live · 79 sub-phases shipped · ~196 routes wired · BFF tests 2492 pass / 9 skipped / 2501 total.**
...
- **M5** — custom template clone-from-library + bulk-clone (M5.9)
