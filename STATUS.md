...
| M5  | Rule Engine                  | M5.1–M5.9                                   | 12-template library · bulk-clone preview · rule simulation · simulation BUNDLE · template diff · per-tenant CUSTOM templates CRUD · custom→simulation/diff merge · PUT (edit) + audit history · M5.9 clone-from-library (turn library template into editable custom; default name "Copy of …", rule.create audit with `cloned_from`) |
...
**Totals:** **16/16 modules live · 80 sub-phases shipped · ~197 routes wired · BFF tests 2501 pass / 9 skipped / 2510 total.**
...
- **M5** — bulk clone-from-library N templates (M5.10)
