...
| M5  | Rule Engine                  | M5.1–M5.10                                  | 12-template library · bulk-clone · simulation · simulation BUNDLE · diff · custom CRUD · custom→simulation/diff merge · PUT + audit history · clone-from-library · M5.10 bulk-clone-from-library (cap 10; per-row created[]/skipped[]; name_prefix override; rule.create audit per success with bulk=true marker) |
...
**Totals:** **16/16 modules live · 98 sub-phases shipped · ~237 routes wired · BFF tests 2937 pass / 9 skipped / 2946 total.**
